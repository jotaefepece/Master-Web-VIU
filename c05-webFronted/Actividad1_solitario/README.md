...
- Guardar puntuaciones y tiempos usando **LocalStorage**.
...
Proyecto desarrollado a partir de una plantilla otorgada.
Estudiante del Máster en Desarrollo Web – VIU.

Repositorio académico destinado a recopilar y versionar los trabajos
realizados durante el máster.
